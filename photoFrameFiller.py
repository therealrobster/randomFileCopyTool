...
#If the requested filesize is larger than the actual filesize we end up in an endless loop.
#lazy fix for this is at the input stage
fileSizeCheckedOK = False
